...
const secondaryImages = document.querySelectorAll('.carousel + .secondary-images img');
...
for (let subImage of subImages) {
    ...
    subImage.addEventListener("click", function() {
        hideAllBorder()
        subImage.classList.add("sub-images-border")

        mainImage.src = `images/image-product-${i}.jpg`
        console.log(`images/image-product-${i}.jpg`)
